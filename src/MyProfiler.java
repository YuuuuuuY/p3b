...
public class MyProfiler<K extends Comparable<K>, V> {
    ...
    public void insert(K key, V value) {
    	...
    	try {
    		...
    		//IllegalNullKeyException, DuplicateKeyException
    		//fail("there are something wrong in insert");
    		System.out.println("there are some wrong in insert");
    	}
    ...
    public void retrieve(K key) {
    	...
    	try {
    		...
    		System.out.println("there are some wrong in get");
    	}
    }
